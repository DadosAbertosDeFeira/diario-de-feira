...
from diario_bot.apis.maria_quiteria import create_api_token, get_gazette_by_date
...
def test_if_get_gazette_by_date_return_result(mocker):
    expected_result = {
        "count": 249,
        "next": "...",
        "previous": None,
